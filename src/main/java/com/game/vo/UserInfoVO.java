...
public class UserInfoVO {
	...
	public String toString() {
		return "UserInfoVO [uiNum=" + uiNum + ", uiName=" + uiName + ", uiId=" + uiId + ", uiPwd=" + uiPwd + ", uiDesc="
				+ uiDesc + ", uiImgPath=" + uiImgPath + ", uiBirth=" + uiBirth + ", credat=" + credat + ", cretim="
				+ cretim + ", lmodat=" + lmodat + ", lmotim=" + lmotim + ", active=" + active + "]";
	}
